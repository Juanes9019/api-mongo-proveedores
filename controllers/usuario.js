...
// Importar modelos
const Usuario = require('../modules/usuario'); // Importa el modelo de Usuario desde el módulo '../modules/usuario'
...
usuarios.forEach(numero => console.log(numero)); // Muestra cada documento de usuario por consola
    res.json({
...
try {
    ...
    usuario.password = bcrypt.hashSync(password, salt); // Cifra la contraseña con la sal generada
...
const usuariosPut = async(req, res = response) => {
    ...
    res.json({
        msg: 'Usuario Modificado', // Devuelve un mensaje indicando que se modificó el usuario
...
const usuariosDelete = async(req, res = response) => {
    ...
    res.json({
        msg: 'Usuario Eliminado', // Devuelve un mensaje indicando que se eliminó el usuario
